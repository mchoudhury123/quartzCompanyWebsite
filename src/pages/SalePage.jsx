          ...
          <div className="sale-hero__grid">
            <div className="sale-hero__left">
              ...
              <p className="sale-hero__subtitle">
                As part of our summer sale, every worktop in our collection is 40% off &mdash; transform your kitchen for less. Hurry, the sale ends 24th July.
              </p>
            </div>
            <div className="sale-hero__right">
              <div className="sale-hero__countdown">
                <span className="sale-hero__countdown-label">Sale Ends</span>
                <span className="sale-hero__countdown-date">24th July</span>
