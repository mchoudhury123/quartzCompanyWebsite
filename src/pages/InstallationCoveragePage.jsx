...
export default function InstallationCoveragePage() {
  ...
  return (
    <div className="coverage-page">
      ...
      {/* Postcode Checker – odd section: left-aligned */}
      ...
      {/* Map Placeholder – even section: right-aligned */}
      ...
      {/* Regions List – odd section: left-aligned */}
      ...
      {/* Lead Times Info Box – even section: right-aligned */}
