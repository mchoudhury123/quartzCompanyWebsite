...
const claimSteps = [
  {
    step: 1,
    title: 'Contact Us',
    description: 'Call our support team on 07375 303 416 or email warranty@thequartzcompany.co.uk. Have your order number and installation date ready.',
  },
  {
    step: 2,
...
export default function WarrantyPage() {
  ...
  return (
    <div className="warranty-page">
      ...
      {/* Warranty Cards — odd section (left-aligned) */}
      ...
      {/* How to Claim — even section (right-aligned) */}
      <section className="war-claims section section--cream">
        <div className="container">
          <div className="war-claims__block war-claims__block--right">
            ...
            <p className="war-claims__subtitle">
      ...
      {/* Certifications — odd section (left-aligned) */}
      <section className="war-certs section">
        <div className="container">
          <div className="war-certs__block war-certs__block--left">
            ...
            <p className="war-certs__subtitle">
